...
issues and other contributions that are not aligned to this Code of Conduct, and will
...
All complaints will be reviewed and investigated promptly and fairly. Maintainers are obliged to
respect the privacy and security of the reporter.

## Enforcement guidelines

1. **Correction.** A private, written warning, with clarity about the violation and why it was
...
3. **Temporary ban.** A temporary ban from any interaction or public communication with the
   community.
